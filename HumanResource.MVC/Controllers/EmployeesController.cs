    ...
    private ApiResourceDefinition GetResource()
    {
        return new ApiResourceDefinition
        {
            ...
            Fields = new List<ApiField>
            {
                ...
                new ApiField { Name = "email", Label = "Email", Type = ApiFieldType.Email, Required = true },
                ...
                new ApiField { Name = "phoneNumber", Label = "Phone", Type = ApiFieldType.Phone, Required = true, Pattern = @"[0-9+\-() ]+", ValidationMessage = "Phone can contain only numbers, spaces, +, -, and brackets." },
